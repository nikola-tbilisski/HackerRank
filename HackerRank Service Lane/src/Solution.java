...
//        //Solution by enhanced loop & sublist() method
//        List<Integer> resultList = new ArrayList<>();
//
//        for (List<Integer> c : cases) {
//            resultList.add(Collections.min(width.subList(c.get(0), c.get(1) + 1)));
//        }
//
//        return resultList;

        //Solution by Java8 stream
        return cases.stream()
                .mapToInt(el -> Collections.min(width.subList(el.get(0), el.get(1) + 1)))
                .boxed()
                .collect(toList());
    }
